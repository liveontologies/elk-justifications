...
#colors = c("red", "blue")
#lineTypes = c("44", "73")
#../src/scripts/plot_row.r '\textsc{GO-Plus}' '\textsc{Galen}' '\textsc{Snomed}' -- "EL2MUS tracing" results/final/17-04-04.go-plus.el2mus.dell.elk.record.csv results/final/17-04-04.galen7.el2mus.dell.elk.record.csv results/final/17-04-11.snomed2015.el2mus.dell.elk.record.csv "EL2MUS x2" results/final/17-03-28.go-plus.el2mus.dell.sat.record.csv results/final/17-03-15.galen7.el2mus.dell.sat.record.csv results/final/17-04-11.snomed2015.el2mus.dell.sat.record.csv
